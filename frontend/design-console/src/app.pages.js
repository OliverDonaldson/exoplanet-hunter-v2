      ...
      <div class="cm-grid" style="display:grid;grid-template-columns:1fr 2fr;gap:2rem">
        ...
        <div class="panel" style="padding:1.5rem">
          ...
          <div style="font-family:'Inter';font-size:0.75rem;line-height:1.6;color:rgba(240,238,232,0.5);margin-top:1.5rem;padding-top:1.25rem;border-top:1px solid rgba(255,255,255,0.06)">
            Intervals are the ±1σ spread over the five folds. Recall @ 1% FPR no longer decides a promotion, though it still rejects a regression beyond its measured floor: it is cut at the ten highest-scoring negatives, and a power analysis on 14 September 2026 put its smallest detectable change at 0.122 — wider than the differences it was being used to decide. It is still what "would this candidate reach the shortlist" means, and it is still the number that rejected all five architecture arms. The gate decides on ROC-AUC, where the same analysis measured 0.013. Nothing currently guards the top of the ranking against a candidate that improves the bulk ordering at the shortlist's expense: a partial-AUC veto was recorded as adopted in September 2026 but was never implemented, and no label-based metric measured here detects a change confined to that region.
          </div>
        </div>
      </div>`;
