...
| **The Kepler set is a configured 45% subsample** | `catalog.py::_stable_sample` md5-ranks by `tic_id` and takes the first n, giving exactly 1,250/1,250 against roughly 2,748 eligible confirmed and 3,813 eligible FPs. Unbiased and refresh-stable, but it is less data than was available, in a project §6.4 shows is power-starved | `catalog.py:440`; [benchmark comparability audit](experiments/benchmark-comparability-2026-09-10.md) |
