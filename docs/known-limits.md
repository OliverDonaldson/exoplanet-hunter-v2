...
| **Only one headline number is benchmarkable, and it loses** | Of six candidate comparisons to published work, five fail on population, protocol or metric definition. The survivor is TESS ROC-AUC 0.9100 against ExoMiner++ 0.998 — same protocol, so the gap is not a protocol artefact. Recall @1% FPR, the metric promotion is decided on, has no published counterpart in any of the five studies | [benchmark comparability audit](experiments/benchmark-comparability-2026-09-10.md), 2026-09-10 |
