...
| ~~P2.2g~~ **DONE 2026-09-24** | **The AUC guard promotes only past its floor.** The AUC call's band became `(0, floor]`; recall keeps its one-sided band (#131). [#128](https://github.com/OliverDonaldson/exoplanet-hunter-v2/issues/128), [pre-registration](experiments/p2-auc-floor-rule-2026-09-24.md), [result](experiments/p2-auc-floor-rule-result-2026-09-24.md) | Not falsified; every prediction held exactly. Size at 5 v 5 **26.7% → 9.0%**, and 1.8% once #123 lands, which is now the next step and justified. Power at the MDE 76.6% against an **81.2% ceiling** the Brier and ECE constants impose ([#134](https://github.com/OliverDonaldson/exoplanet-hunter-v2/issues/134)) | done |
...
| ~~P2.2d~~ · pre-registered 2026-09-20, falsified as P2.2e, **closed by P2.2g 2026-09-24**, which unblocks P2.2b | **The UNRESOLVED band has a hole under it: a positive margin below `floor/1.5` promotes.** The rule is not monotone — 2 se promotes 38.8% against 49.5% at 1 se — and gives 49% power at the MDE published as 80%. Until it is closed, a more accurate floor is a worse gate. [#128](https://github.com/OliverDonaldson/exoplanet-hunter-v2/issues/128), [p2-unresolved-band-2026-09-20.md](experiments/p2-unresolved-band-2026-09-20.md) | A monotone rule; measured size in single figures; power at one MDE matching what that MDE asserts | ≈2 h, no training |
